    ...
    public class BidsController : ControllerBase
    {
        ...
        public async Task<ActionResult<BidDto>> PlaceBid(string auctionId, int amount)
        {
            ...
            } else
            {
                ...
                .Match(a => a.AuctionId == auctionId).Sort(x =>x.Descending(b =>b.Amount)).ExecuteFirstAsync();
        ...
        [HttpGet("{auctionId}")]
        public async Task<ActionResult<List<BidDto>>> GetAuctionById(String auctionId)
        {
            var bids = await DB.Find<Bid>()
                .Match(a => a.AuctionId == auctionId).Sort(x =>x.Descending(a => a.BidTime)).ExecuteAsync();
